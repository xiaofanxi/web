...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/x/aaa/index.html'));
    });
    ...
    resolve('bbb', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/y/bbb/index.html'));
    });
    ...
    resolve('ccc', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/x/ccc/index.html'));
    });
