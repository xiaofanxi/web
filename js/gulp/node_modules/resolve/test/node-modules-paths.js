...
var verifyDirs = function verifyDirs(t, start, dirs, moduleDirectories, paths) {
    ...
    t.deepEqual(foundModuleDirNames, moduleDirs.concat(paths || []), 'all desired seaRequire dirs were found');
    ...
    t.equal(keys(counts).length, 1, 'all found seaRequire directories had the same count');
};
