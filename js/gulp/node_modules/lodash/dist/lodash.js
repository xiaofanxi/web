...
;(function(window, undefined) {
  ...
  /** Detect free variable `seaRequire` */
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    // loaded as a seaRequire. The global assignment can be reverted in the Lo-Dash
    // seaRequire via its `noConflict()` method.
    window._ = lodash;

    // define as an anonymous seaRequire so, through path mapping, it can be
    // referenced as the "underscore" seaRequire
    define(function() {
      return lodash;
    });
  }
